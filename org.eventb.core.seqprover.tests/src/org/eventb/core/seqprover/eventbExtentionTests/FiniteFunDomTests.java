 ...
 * @author htson
 */
public class FiniteFunDomTests extends AbstractSingleExpressionInputReasonerTests {

	String P1 = "finite(dom({0 ↦ (3 ↦ 2),1 ↦ (3 ↦ x),1 ↦ (2 ↦ 3)}))";

	String resultP1GoalA = "{x=ℤ}[][][⊤] |- {0 ↦ (3 ↦ 2),1 ↦ (3 ↦ x),1 ↦ (2 ↦ 3)}∼∈ℕ × ℕ ⇸ ℕ";

	String resultP1GoalB = "{x=ℤ}[][][⊤] |- finite(ℕ × ℕ)";
		
	String P2 = "x = 1 ⇒ finite(dom({0 ↦ (3 ↦ 2),1 ↦ (3 ↦ x),1 ↦ (2 ↦ 3)}))";
	...
	protected String[] getUnsuccessfulTests() {
		return new String[] {
				...
				null,
				"ℕ",
				"Goal is not a finiteness of domain of a function"
		};
	}
