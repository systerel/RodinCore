...
/**
 * Unit tests for the Finite of range of a function reasoner {@link FiniteFunRan}
 * 
 * @author htson
 */
public class FiniteFunRanTests extends AbstractPFunSetInputReasonerTests {

	private static final String P1 = "finite(ran({0 ↦ (3 ↦ 2),1 ↦ (3 ↦ x),1 ↦ (2 ↦ 3)}))";
	...
	private static final String P2 = "x = 1 ⇒ finite(ran({0 ↦ (3 ↦ 2),1 ↦ (3 ↦ x),1 ↦ (2 ↦ 3)}))";

	private static final String P3 = "finite({0 ↦ 3,1 ↦ x,1 ↦ 2}[{x}])";

    private static final String P4 = "finite(ran({0 ↦ 1}))";
	...
	protected List<IPosition> getPositions(Predicate predicate) {
		return Tactics.finiteFunRanGetPositions(predicate);
	}
	
	@Override
	public String getReasonerID() {
		return "org.eventb.core.seqprover.finiteFunRan";
	}
