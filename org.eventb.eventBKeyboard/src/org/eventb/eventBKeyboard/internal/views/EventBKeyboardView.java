...
/**
 * @author htson
 * This simple view allow you to enter a mathematical expression of Event-B
 * language and translate that into Unicode.
 * <p>
 * Happy typing !!!
 */
public class EventBKeyboardView
	extends ViewPart 
	implements IPropertyChangeListener
{
	 ...
	 * to create the text area and the check button and initialize it.
	 */
	public void createPartControl(Composite parent) {
		...
		formula = new Text(parent, SWT.MULTI | SWT.V_SCROLL |SWT.BORDER |SWT.H_SCROLL);
	 ...
	 */
	public Text getFormula() {return formula;}

	/**
	 * @return The ModifyListener associate with the Text
	 */
	public EventBTextModifyListener getListener() {return listener;}
