...
public class NewEnumeratedSetDialog extends EventBDialog {
	 ...
	 */
	public NewEnumeratedSetDialog(IWizardElementMaker enumeratedSetMaker,
			String title, String defaultName) {
		super(enumeratedSetMaker.getShell(), enumeratedSetMaker.getRoot(),
				title, enumeratedSetMaker);
