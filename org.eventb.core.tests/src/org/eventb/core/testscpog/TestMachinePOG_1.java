...
public class TestMachinePOG_1 extends BuilderTest {
	...
	public final void testRun() throws Exception {
		ISCMachineFile machine = createMachineOne();
		IPOFile poFile = runPOG(machine);
		assertTrue("Proof obligations not produced", poFile.exists());
	}

	private ISCMachineFile createMachineOne() throws RodinDBException {
		ISCMachineFile rodinFile = createSCMachine("one");
