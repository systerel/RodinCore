...
public final class Messages {
	...
	public static String scuser_UnknownConfiguration;
	public static String scuser_RepositoryFactoryLoadingError;
    ...
    public static String scuser_VariantLabelConflict;
