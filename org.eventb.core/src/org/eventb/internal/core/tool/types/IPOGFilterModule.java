 ...
 * proof obligation is not generated. The execution of the processor module is not affected
 * otherwise so that all side-effects can take place, in particular, updates of the
 * state repository.
 * 
 * @see POGFilterModule
