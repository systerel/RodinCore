...
public final class EventBAttributes {
	 ...
	 * @since 3.0
	 */
	public static IAttributeType.Boolean CONTEXT_DEPENDENT_ATTRIBUTE =
			RodinCore.getBooleanAttrType(EventBPlugin.PLUGIN_ID + ".contextDependent");
	 ...
	 * @since 3.0
	 */
	public static final IAttributeType.String HIDDEN_HYPS_ATTRIBUTE =
			RodinCore.getStringAttrType(EventBPlugin.PLUGIN_ID + ".prHidden");
