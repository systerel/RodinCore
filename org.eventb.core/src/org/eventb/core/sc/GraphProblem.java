...
public enum GraphProblem implements IRodinProblem {
	...
	scuser_ActionDisjointLHSError(IMarker.SEVERITY_ERROR, Messages.scuser_ActionDisjointLHSError),
	...
	ConvergentFaultyConvergenceWarning(IMarker.SEVERITY_ERROR, Messages.scuser_ConvergentFaultyConvergence),
	OrdinaryFaultyConvergenceWarning(IMarker.SEVERITY_ERROR, Messages.scuser_OrdinaryFaultyConvergence),
	AnticipatedFaultyConvergence(IMarker.SEVERITY_ERROR, Messages.scuser_AnticipatedFaultyConvergence),
	AnticipatedEventNoVariant(IMarker.SEVERITY_ERROR, Messages.scuser_AnticipatedEventNoVariant),
	ConvergentEventNoVariant(IMarker.SEVERITY_ERROR, Messages.scuser_ConvergentEventNoVariant),
