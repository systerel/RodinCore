 ...
 *
 */
public interface IPSFileRename extends IRodinFile{
	...
	IPSstatusRename[] getStatus() throws RodinDBException;
	
	IPSstatusRename getStatus(String name) throws RodinDBException;
