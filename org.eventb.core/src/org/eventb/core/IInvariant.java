 ...
 * <p>
 * An invariant has a name that is returned by
 ...
 */
public interface IInvariant extends ILabeledElement, IPredicateElement {

	String ELEMENT_TYPE = EventBPlugin.PLUGIN_ID + ".invariant"; //$NON-NLS-1$
