 ...
 *         displaying carrier sets.
 */
public class CarrierSetMasterSection extends EventBTreePartWithButtons {
	...
	// The labels corresponds with the above buttons.
	...
	protected EventBEditableTreeViewer createTreeViewer(
		...
		return new CarrierSetEditableTreeViewer(editor, parent, SWT.MULTI
