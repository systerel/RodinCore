	...
	extends NewEventBTablePartWithButtons
{
	...
	private static final String SECTION_TITLE = "Carrier Sets";
	...
	protected void setProvider() {
		...
		viewer.setContentProvider(new CarrierSetContentProvider());
		viewer.setLabelProvider(new CarrierSetLabelProvider());
	}
	...
	protected EventBEditableTableViewer createTableViewer(IManagedForm managedForm, FormToolkit toolkit, Composite parent) {
		return new CarrierSetEditableTableViewer(parent, SWT.MULTI | SWT.H_SCROLL | SWT.V_SCROLL | SWT.FULL_SELECTION, editor.getRodinInput());
	}
