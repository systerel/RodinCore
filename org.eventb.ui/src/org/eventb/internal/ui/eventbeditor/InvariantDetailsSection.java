 ...
 * for editing Invariant object (Rodin Element).
 */
public class InvariantDetailsSection
	extends EventBDetailsSection
{
	 ...
	 * @param input The Invariant (Rodin Element) associated with this
	 */
	public InvariantDetailsSection(EventBMasterDetailsBlock block, IInternalElement input) {
		super(block, input);
	}
