	...
	extends EventBMirror
{
	 ...
	 */
	public static final String VIEW_ID = EventBUIPlugin.PLUGIN_ID +".views.CarrierSetMirror";

	private String defaultText = "A mirror of the carrier sets is not available";
