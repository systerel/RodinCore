	...
	implements IElementChangedListener
{
	...
	public NewEventBTablePartWithButtons(final IManagedForm managedForm, Composite parent, FormToolkit toolkit, 
		...
		viewer = createTableViewer(managedForm, toolkit, client);
		setProvider();
		...
		this.getViewer().addSelectionChangedListener(new ISelectionChangedListener() {
			public void selectionChanged(SelectionChangedEvent event) {
				managedForm.fireSelectionChanged(NewEventBTablePartWithButtons.this, event.getSelection());
				updateButtons();
			}
		});
	...
	private class SelectionHandler implements SelectionListener {
		...
		private void buttonSelected(SelectionEvent e) {
			...
			NewEventBTablePartWithButtons.this.buttonSelected(index.intValue());
		}
	}
	...
	protected EventBEditableTableViewer getViewer() {return viewer;}
