...
public class VariableEditableTableViewer extends EventBEditableTableViewer {
	...
	public VariableEditableTableViewer(Composite parent, int style, IRodinFile rodinFile) {
		super(parent, style, rodinFile);
		this.setContentProvider(new VariableContentProvider());
		this.setLabelProvider(new VariableLabelProvider());
	}
