 ...
 */
public class EventBMasterSectionActionGroup
	extends ActionGroup 
{
	 ...
	 */
	public EventBMasterSectionActionGroup(EventBEditor eventBEditor, TreeViewer treeViewer) {
		...
		addVariable.setImageDescriptor(new EventBImageDescriptor(EventBImage.IMG_NEW_PROJECT));
		...
		addInvariant.setImageDescriptor(new EventBImageDescriptor(EventBImage.IMG_NEW_PROJECT));
		...
		addTheorem.setImageDescriptor(new EventBImageDescriptor(EventBImage.IMG_NEW_PROJECT));
		...
		addEvent.setImageDescriptor(new EventBImageDescriptor(EventBImage.IMG_NEW_PROJECT));
		...
		addLocalVariable.setImageDescriptor(new EventBImageDescriptor(EventBImage.IMG_NEW_PROJECT));
		...
		addGuard.setImageDescriptor(new EventBImageDescriptor(EventBImage.IMG_NEW_PROJECT));
		...
		addAction.setImageDescriptor(new EventBImageDescriptor(EventBImage.IMG_NEW_PROJECT));
		...
		addSet.setImageDescriptor(new EventBImageDescriptor(EventBImage.IMG_NEW_PROJECT));
		...
		addConstant.setImageDescriptor(new EventBImageDescriptor(EventBImage.IMG_NEW_PROJECT));
		...
		addAxiom.setImageDescriptor(new EventBImageDescriptor(EventBImage.IMG_NEW_PROJECT));
				...
				BusyIndicator.showWhile(viewer.getTree().getDisplay(),
						new Runnable() {
							public void run() {
								...
								try {
									((IInternalElement) currObj).move(currObj.getParent(), prevObj, null, true, null);
		...
		handleUp.setImageDescriptor(new EventBImageDescriptor(EventBImage.IMG_NEW_PROJECT));
		...
		handleDown.setImageDescriptor(new EventBImageDescriptor(EventBImage.IMG_NEW_PROJECT));
	}
