 ...
 * @author htson
 *         <p>
 *         An implementation of the Event-B Table part with buttons for
 *         displaying theorems (used as master section in Master-Detail block).
 */
public class TheoremMasterSection extends EventBTreePartWithButtons {
	...
	public void elementChanged(final ElementChangedEvent event) {
		syncExec(new Runnable() {
			public void run() {
				if (TheoremMasterSection.this.getViewer().getControl().isDisposed())
					return;
				((EventBEditableTreeViewer) TheoremMasterSection.this
