 ...
 * for editing Theorem object (Rodin Element).
 */
public class TheoremDetailsSection 
	extends EventBDetailsSection 
{
	 ...
	 * @param input The Theroem (Rodin Element) associated with this
	 */
	public TheoremDetailsSection(EventBMasterDetailsBlock block, ITheorem input) {
		super(block, input);
	}
	...
	public void createClient(Section section, FormToolkit toolkit) {
        ...
        EventBInputRow name = new NameInputRow(this, toolkit, comp, "name*", "Name of the theorem");
        addRow(name);
        
        String string = "predicate*";
        String tip = "Predicate associated with the theorem";
