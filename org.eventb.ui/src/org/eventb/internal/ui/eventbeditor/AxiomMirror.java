	...
	extends EventBMirror
{
	 ...
	 */
	public static final String VIEW_ID = EventBUIPlugin.PLUGIN_ID +".views.AxiomMirror";

	private String defaultText = "A mirror of the axioms is not available";
