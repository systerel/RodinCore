 ...
 *     Systerel - added a constructor taking a single value
 *******************************************************************************/
...
class ChangeAttribute extends OperationLeaf {
	...
	public ChangeAttribute(IInternalElement element, IAttributeValue value) {
		super("ChangeAttribute");
		this.element = element;
		this.values = new IAttributeValue[]{value};
	}
