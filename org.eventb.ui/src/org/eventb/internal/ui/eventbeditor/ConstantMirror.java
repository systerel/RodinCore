	...
	extends EventBMirror
{
	 ...
	 */
	public static final String VIEW_ID = EventBUIPlugin.PLUGIN_ID +".views.ConstantMirror";

	private String defaultText = "A mirror of the constants is not available";
