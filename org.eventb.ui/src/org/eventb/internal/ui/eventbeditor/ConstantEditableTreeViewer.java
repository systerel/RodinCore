...
//				try {
//					IRodinElement [] csts =   ((IContext) parent).getChildrenOfType(IConstant.ELEMENT_TYPE);
//					for (IRodinElement cst : csts) {
////						UIUtils.debug("Event: " + event.getElementName());
//						Node node = new Node(cst);
//						elementsMap.put(cst, node);
//						list.add(node);
//					}
//				}
...
//			elementsMap = new HashMap<IRodinElement, Leaf>();
	...
	public ConstantEditableTreeViewer(EventBEditor editor, Composite parent, int style) {
