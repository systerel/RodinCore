...
public class RemainingGoals extends ViewPart {
	...
	class ViewContentProvider implements IStructuredContentProvider {
		...
		public Object[] getElements(Object parent) {
			if (parent instanceof ProverUI) {
				if (parent != null)
					return ((ProverUI) parent).getRemainingObligations().toArray();
	 ...
	 * The constructor.
	 */
	public RemainingGoals() {
		// Register with the main plugin
//		ProverUIPlugin.getDefault().setRemainingGoalsView(this);
	}
	...
	private void hookContextMenu() {
		...
		menuMgr.addMenuListener(new IMenuListener() {
			public void menuAboutToShow(IMenuManager manager) {
				RemainingGoals.this.fillContextMenu(manager);
			}
		});
