...
/**
 * Provider for the "direct product fun. image" tactic.
 *
 * @author Guillaume Verdier
 */
public class FunDprodImg extends AbstractHypGoalTacticProvider {

	public static class FunDprodImgApplication extends DefaultPositionApplication {

		private static final String TACTIC_ID = "org.eventb.ui.funDprodImg";

		public FunDprodImgApplication(Predicate hyp, IPosition position) {
			super(hyp, position);
		}

		@Override
		public ITactic getTactic(String[] inputs, String globalInput) {
			return Tactics.funDprodImg(hyp, position);
		}
	...
	protected List<ITacticApplication> getApplicationsOnPredicate(IProofTreeNode node, Predicate hyp,
		...
		return adaptPositionsToApplications(hyp, predicate, Tactics::funDprodImgGetPositions,
				FunDprodImgApplication::new);
	}
