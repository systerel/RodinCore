...
public class FunCompImgGoal extends DefaultTacticProvider {

	@Override
	@Deprecated
	public ITactic getTactic(IProofTreeNode node, Predicate hyp,
			IPosition position, String[] inputs) {
		return Tactics.funCompImg(null, position);
	}
	...
	public List<IPosition> getApplicablePositions(IProofTreeNode node,
		...
		List<IPosition> positions = Tactics.funCompImgGetPositions(goal);
		if (positions.size() == 0) {
			return null;
		}
		return positions;
