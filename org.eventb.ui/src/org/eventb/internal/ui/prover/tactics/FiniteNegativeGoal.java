 ...
 * <ul>
 */
public class FiniteNegativeGoal implements ITacticProvider2 {
	...
	public List<ITacticApplication> getPossibleApplications(
		...
		if (Lib.isFinite(goal)) {
			if (Lib.isSetOfIntegers(((SimplePredicate) goal).getExpression())) {
				final ITacticApplication appli = new FiniteNegativeGoalApplication();
