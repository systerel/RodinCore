...
import static org.eventb.core.seqprover.eventbExtensions.Tactics.finiteFunDomGetPositions;
...
public class FiniteFunDomGoal implements ITacticProvider {
	...
	public List<ITacticApplication> getPossibleApplications(
		...
		if (finiteFunDomGetPositions(goal).isEmpty()) {
			return emptyList();
		} else {
			return singletonList(new FiniteFunDomGoalApplication(node));
		}
	}
