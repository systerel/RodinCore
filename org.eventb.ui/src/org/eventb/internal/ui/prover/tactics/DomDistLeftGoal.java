...
public class DomDistLeftGoal extends DefaultTacticProvider {

	@Override
	@Deprecated
	public ITactic getTactic(IProofTreeNode node, Predicate hyp,
			IPosition position, String[] inputs) {
		return Tactics.domDistLeftRewrites(null, position);
	}
	...
	public List<IPosition> getApplicablePositions(IProofTreeNode node,
		...
		List<IPosition> positions = Tactics.domDistLeftGetPositions(goal);
		if (positions.size() == 0) {
			return null;
		}
		return positions;
