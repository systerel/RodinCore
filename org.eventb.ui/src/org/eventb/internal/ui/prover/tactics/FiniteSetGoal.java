...
import static org.eventb.core.seqprover.eventbExtensions.Tactics.finiteSetGetPositions;
...
public class FiniteSetGoal implements ITacticProvider {
	...
	public List<ITacticApplication> getPossibleApplications(
		...
		if (finiteSetGetPositions(goal).isEmpty()) {
			return emptyList();
		} else {
			return singletonList(new FiniteSetGoalApplication(node));
		}
	}
