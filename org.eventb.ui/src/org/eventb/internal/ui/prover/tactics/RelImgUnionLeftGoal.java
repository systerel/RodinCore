...
public class RelImgUnionLeftGoal extends DefaultTacticProvider {

	@Override
	@Deprecated
	public ITactic getTactic(IProofTreeNode node, Predicate hyp,
			IPosition position, String[] inputs) {
		return Tactics.relImgUnionLeftRewrites(null, position);
	}
	...
	public List<IPosition> getApplicablePositions(IProofTreeNode node,
		...
		List<IPosition> positions = Tactics.relImgUnionLeftGetPositions(goal);
		if (positions.size() == 0) {
			return null;
		}
		return positions;
