...
public class RelImgUnionRightGoal extends DefaultTacticProvider {

	@Override
	@Deprecated
	public ITactic getTactic(IProofTreeNode node, Predicate hyp,
			IPosition position, String[] inputs) {
		return Tactics.relImgUnionRightRewrites(null, position);
	}
	...
	public List<IPosition> getApplicablePositions(IProofTreeNode node,
		...
		List<IPosition> positions = Tactics.relImgUnionRightGetPositions(goal);
		if (positions.size() == 0) {
			return null;
		}
		return positions;
