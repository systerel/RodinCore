...
public class InclusionSetMinusLeft extends InclusionSetMinus {
	...
	public static class InclusionSetMinusLeftAppliInspector extends
			DefaultApplicationInspector {

		public InclusionSetMinusLeftAppliInspector(Predicate hyp) {
			super(hyp);
		}
		...
		public void inspect(RelationalPredicate predicate,
			...
			if (predicate.getTag() == Predicate.SUBSETEQ) {
				if (Lib.isSetMinus(predicate.getLeft())) {
					...
					accumulator.add(new InclusionSetMinusLeftApplication(hyp,
							position));
				}
			}
		}
	...
	protected List<ITacticApplication> getApplicationsOnPredicate(
			...
			Predicate predicate) {
		return predicate.inspect(new InclusionSetMinusLeftAppliInspector(hyp));
	}
