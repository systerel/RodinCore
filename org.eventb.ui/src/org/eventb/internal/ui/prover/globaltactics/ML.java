...
import org.eventb.internal.ui.prover.ProofControlPage;
 ...
 *         mono-lemma external prover in all forces.
 */
public class ML implements IGlobalTactic {
	...
	public void apply(UserSupport userSupport, String input)
		...
		ProofControlPage.runML(userSupport, ExternalML.Input.FORCE_0
				| ExternalML.Input.FORCE_1 | ExternalML.Input.FORCE_2
