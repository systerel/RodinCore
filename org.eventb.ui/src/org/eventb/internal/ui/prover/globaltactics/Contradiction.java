 ...
 * @author htson
 *         <p>
 *         This class is an implementation of IGlobalTactic for proving by
 *         contradiction.
 */
public class Contradiction implements IGlobalTactic {
	...
	public void apply(UserSupport userSupport, String input)
		...
		userSupport.applyTactic(Tactics.contradictGoal());
	}
