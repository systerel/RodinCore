 ...
 */
public class ObligationExplorerActionGroup 
	extends ActionGroup 
{
...
//	public static Action proveAction;
	 ...
	 * @param obligationExplorer The project explorer
	 */
	public ObligationExplorerActionGroup(ObligationExplorer obligationExplorer) {
		...
		refreshAction = new RefreshAction(obligationExplorer.getSite().getShell());
