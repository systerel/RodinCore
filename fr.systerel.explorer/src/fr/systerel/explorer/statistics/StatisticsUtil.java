...
public class StatisticsUtil {
	 ...
	 * @return <code>null</code>, if the selection is valid, otherwise a String describing why it is not valid.
	 */
	 ...
	 * @return <code>true</code>, if the details view is required, <code>false</code> otherwise
	 */
	public static boolean detailsRequired(Object[] elements) {
		...
		if (elements[0] instanceof IProject || elements[0] instanceof IMachineRoot  
				|| elements[0] instanceof IContextRoot  || elements[0] instanceof IElementNode) {
			return true;
		}
