...
public class ButtonManager {
	...
	public ButtonManager(DocumentMapper documentMapper, StyledText styledText, ProjectionViewer viewer, RodinEditor editor) {
	...
	public void createButtons() {
		createMenu();
		EditorElement[] elements = documentMapper.getEditorElements();
		for (EditorElement element : elements) {
			ElementButton button = new ElementButton(styledText, element, viewer);
