...
public class NewConstantDialog extends EventBDialog {
	 ...
	 */
	public NewConstantDialog(IWizardElementMaker constantElementMaker,
			String title) {
		super(constantElementMaker.getShell(), constantElementMaker.getRoot(),
				title, constantElementMaker);
