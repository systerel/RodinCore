...
import static org.eventb.core.indexer.tests.OccUtils.makeDeclList;
import static org.eventb.core.indexer.tests.OccUtils.makeOccDecl;
import static org.eventb.core.indexer.tests.OccUtils.makeOccList;
import static org.eventb.core.indexer.tests.OccUtils.makeOccRefPred;
...
public class MachineIndexerTests extends EventBIndexerTests {
	...
	public void testDeclaration() throws Exception {
		...
		final IMachineFile machine = createMachine(project, MCH_FILE_NAME,
				VAR_1DECL);
	...
	public void testOccurrence() throws Exception {
		...
		final IOccurrence occDecl = makeOccDecl(machine);
	...
	public void testOccurrenceOtherThanDecl() throws Exception {
		...
		final IOccurrence occRef = makeOccRefPred(invariant, 0, 4);
	...
	public void testDoubleOccurrenceSameElement() throws Exception {
		...
		final IInvariant invariant = machine.getInvariant(INTERNAL_ELEMENT1);
		final IOccurrence occRef1 = makeOccRefPred(invariant, 0, 4);
		final IOccurrence occRef2 = makeOccRefPred(invariant, 7, 11);
	...
	public void testDoNotExportImportedNoDecl() throws Exception {
		...
		final IMachineFile exporter = createMachine(project, MCH_FILE_NAME,
				VAR_1DECL);
		...
		final IMachineFile importer = createMachine(project, MCH_FILE_NAME,
				EMPTY_MACHINE);
	...
	public void testImportedOccurrence() throws Exception {
		...
		final IOccurrence occVar1 = makeOccRefPred(invariant, 0, 4);
	...
	public void testUnknownElement() throws Exception {
		final IMachineFile independent = createMachine(project, MCH_FILE_NAME,
				VAR_1DECL);
	...
	public void testTwoImportsSameName() throws Exception {
		final IMachineFile exporter1 = createMachine(project, MCH_FILE_NAME,
				VAR_1DECL);
		final IDeclaration declVarExp1 = getDeclVar(exporter1,
				INTERNAL_ELEMENT1, VAR1);

		final IMachineFile exporter2 = createMachine(project, MCH_FILE_NAME,
				VAR_1DECL);
	...
	// TODO tests with other elements than variables.
	// TODO tests with occurrences other than in invariants.
	...
	public void testBadFileType() throws Exception {
		...
		final IContextFile context = createContext(project, "file.buc",
				CST_1DECL_1REF_THM);
