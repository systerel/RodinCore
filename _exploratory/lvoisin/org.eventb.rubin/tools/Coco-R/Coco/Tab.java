...
public class Tab {
	...
	public BitSet ignored;             // characters ignored by the scanner
	...
	public CharClass NewCharClass(String name, BitSet s) {
	...
	public CharClass FindCharClass(BitSet s) {
		//foreach (CharClass c in classes)
		for (int i = 0; i < classes.size(); i++) {
			CharClass c = (CharClass)classes.get(i);
	...
	public BitSet CharClassSet(int i) {
