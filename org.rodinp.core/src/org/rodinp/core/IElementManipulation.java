...
/**
 * Common protocol for Rodin elements that support manipulations such
...
public interface IElementManipulation {
	 ...
	 * @exception RodinDBException if this element could not be copied. Reasons include:
	 * <ul>
	 ...
	 */
	void copy(IRodinElement container, IRodinElement sibling, String rename, boolean replace, IProgressMonitor monitor) throws RodinDBException;
