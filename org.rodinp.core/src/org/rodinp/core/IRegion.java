 ...
 * Strongly inspired by org.eclipse.jdt.core.IRegion.java which is
 * 
...
/**
 * A Rodin database region describes a hierarchical set of elements.
 ...
 * Instances can be created via the <code>RodinCore.newRegion</code>.
 * </p>
 *
...
public interface IRegion {
	 ...
	 * directly, or because one of its antecedents has been added to this region.
	 * </p>
	 * 
	 * @param element
	 *            the given element
