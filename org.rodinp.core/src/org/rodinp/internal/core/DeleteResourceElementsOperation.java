 ...
 *     ETH Zurich - adapted from org.eclipse.jdt.internal.core.DeleteResourceElementsOperation
 *******************************************************************************/
...
public class DeleteResourceElementsOperation extends MultiOperation {
	...
	protected void processElement(IRodinElement element) throws RodinDBException {
		...
		final RodinElementDelta delta = getDeltaFor(element.getRodinProject());
