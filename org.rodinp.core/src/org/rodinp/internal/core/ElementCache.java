 ...
 */
// TODO rename in OpenableCache?
public class ElementCache extends OverflowingLRUCache<Openable, RodinElementInfo> {
	 ...
	 */
	@Override
	protected ElementCache newInstance(int size, int overflow) {
