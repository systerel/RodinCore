...
public class ItemRelations {
	...
	public void setRelations() {
		...
		elementTypes.setUbiquitousElementTypes(relComputer
				.getUbiquitousElementTypes());
		attributeTypes.setUbiquitousAttributeTypes(relComputer
				.getUbiquitousAttributeTypes());
