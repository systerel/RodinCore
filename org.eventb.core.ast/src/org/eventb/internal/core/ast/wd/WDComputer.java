...
public class WDComputer implements ISimpleVisitor2 {
	...
	public Predicate binExprWD(BinaryExpression expr, Expression left,
			Expression right) {
		switch (expr.getTag()) {
		case DIV:
	...
	public void visitExtendedPredicate(ExtendedPredicate predicate) {
		...
		final WDMediator wdMed = new WDMediator(fb);
		final Predicate extensionWD = extension
				.getWDPredicate(predicate, wdMed);
	...
	public void visitExtendedExpression(ExtendedExpression expression) {
		...
		final WDMediator wdMed = new WDMediator(fb);
		final Predicate extensionWD = extension.getWDPredicate(expression,
				wdMed);
	...
	private Predicate addChildrenWD(Predicate initialWD,
		...
		return fb.land(exprWD, predWD, initialWD);
	}
