...
public class DomDistRightRewrites extends AbstractManualRewrites {

	public static final String REASONER_ID = SequentProver.PLUGIN_ID
			+ ".domDistRightRewrites";
	...
	protected String getDisplayName(Predicate pred, IPosition position) {
		if (pred == null)
			return "rewrites domain distribution right in goal";
		return "rewrites domain distribution right in hyp ("
