...
public class RanDistLeftRewrites extends AbstractManualRewrites {
	...
	protected String getDisplayName(Predicate pred, IPosition position) {
		if (pred == null)
			return "rewrites range distribution left in goal";
		return "rewrites range distribution left in hyp ("
	...
	public Predicate rewrite(Predicate pred, IPosition position, FormulaFactory ff) {
		IFormulaRewriter rewriter = new RanDistLeftRewriterImpl(ff);
