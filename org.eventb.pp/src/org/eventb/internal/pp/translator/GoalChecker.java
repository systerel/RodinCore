...
static private  BoundIdentDecl[]  tom_append_array_bidList( BoundIdentDecl[]  l2,  BoundIdentDecl[]  l1) {
    ...
    if(tom_is_fun_sym_AssociativePredicate(tom_match1_1) ||  false ) {
      { Predicate[]  tom_match1_1_children=tom_get_slot_AssociativePredicate_children(tom_match1_1);
      { Predicate[]  children=tom_match1_1_children;
    ...
    if(tom_is_fun_sym_UnaryPredicate(tom_match1_1) ||  false ) {
      { Predicate  tom_match1_1_child=tom_get_slot_UnaryPredicate_child(tom_match1_1);
      { Predicate  P=tom_match1_1_child;

				return isInGoal(P, ff);
			}
}
    }
    if(tom_is_fun_sym_QuantifiedPredicate(tom_match1_1) ||  false ) {
      { Predicate  tom_match1_1_predicate=tom_get_slot_QuantifiedPredicate_predicate(tom_match1_1);
    ...
    if(tom_is_fun_sym_LiteralPredicate(tom_match1_1) ||  false ) {

				return true;
			    }
    if(tom_is_fun_sym_NotEqual(tom_match1_1) ||  false ) {
      { Expression  tom_match1_1_left=tom_get_slot_NotEqual_left(tom_match1_1);
      { Expression  tom_match1_1_right=tom_get_slot_NotEqual_right(tom_match1_1);
...
/*TODO: control*/	(isMapletExpression(E1, ff) && isMapletExpression(E2, ff));
    ...
    if(tom_is_fun_sym_Plus(tom_match2_1) ||  false ) {
      { Expression[]  tom_match2_1_children=tom_get_slot_Plus_children(tom_match2_1);
      { Expression[]  children=tom_match2_1_children;
    ...
    if(tom_is_fun_sym_Mul(tom_match2_1) ||  false ) {
      { Expression[]  tom_match2_1_children=tom_get_slot_Mul_children(tom_match2_1);
      { Expression[]  children=tom_match2_1_children;
    ...
    if(tom_is_fun_sym_Minus(tom_match2_1) ||  false ) {
      { Expression  tom_match2_1_left=tom_get_slot_Minus_left(tom_match2_1);
      { Expression  tom_match2_1_right=tom_get_slot_Minus_right(tom_match2_1);
      { Expression  AE1=tom_match2_1_left;
      { Expression  AE2=tom_match2_1_right;
    ...
    if(tom_is_fun_sym_Div(tom_match2_1) ||  false ) {
      { Expression  tom_match2_1_left=tom_get_slot_Div_left(tom_match2_1);
      { Expression  tom_match2_1_right=tom_get_slot_Div_right(tom_match2_1);
      { Expression  AE1=tom_match2_1_left;
      { Expression  AE2=tom_match2_1_right;
    ...
    if(tom_is_fun_sym_Mod(tom_match2_1) ||  false ) {
      { Expression  tom_match2_1_left=tom_get_slot_Mod_left(tom_match2_1);
      { Expression  tom_match2_1_right=tom_get_slot_Mod_right(tom_match2_1);
      { Expression  AE1=tom_match2_1_left;
      { Expression  AE2=tom_match2_1_right;
    ...
    if(tom_is_fun_sym_Expn(tom_match2_1) ||  false ) {
      { Expression  tom_match2_1_left=tom_get_slot_Expn_left(tom_match2_1);
      { Expression  tom_match2_1_right=tom_get_slot_Expn_right(tom_match2_1);
      { Expression  AE1=tom_match2_1_left;
      { Expression  AE2=tom_match2_1_right;
    ...
    if(tom_is_fun_sym_UnMinus(tom_match2_1) ||  false ) {
      { Expression  tom_match2_1_child=tom_get_slot_UnMinus_child(tom_match2_1);
      { Expression  AE=tom_match2_1_child;

				return isArithmeticExpression(AE, ff);
			}
}
    }
    if(tom_is_fun_sym_Identifier(tom_match2_1) ||  false ) {

				return expr.getType() == ff.makeIntegerType();
			    }
    if(tom_is_fun_sym_IntegerLiteral(tom_match2_1) ||  false ) {
    ...
    if(tom_is_fun_sym_Identifier(tom_match3_1) ||  false ) {
	...
	public static boolean isMapletExpression(Expression expr, FormulaFactory ff) {
		    { Expression  tom_match4_1=(( Expression )expr);
    if(tom_is_fun_sym_Mapsto(tom_match4_1) ||  false ) {
      { Expression  tom_match4_1_left=tom_get_slot_Mapsto_left(tom_match4_1);
      { Expression  tom_match4_1_right=tom_get_slot_Mapsto_right(tom_match4_1);
      { Expression  l=tom_match4_1_left;
      { Expression  r=tom_match4_1_right;
    ...
    if(tom_is_fun_sym_BoundIdentifier(tom_match4_1) ||  false ) {
 
				return true; 
			    }
    if(tom_is_fun_sym_FreeIdentifier(tom_match4_1) ||  false ) {
 
				return true; 
			    }
    if(tom_is_fun_sym_INTEGER(tom_match4_1) ||  false ) {
 
				return true; 
			    }
    if(tom_is_fun_sym_BOOL(tom_match4_1) ||  false ) {
	...
	public static boolean isBooleanExpression(Expression expr, FormulaFactory ff) {
		    { Expression  tom_match5_1=(( Expression )expr);
    if(tom_is_fun_sym_TRUE(tom_match5_1) ||  false ) {

				return true;
			    }
    if(tom_is_fun_sym_Identifier(tom_match5_1) ||  false ) {
