...
static private  BoundIdentDecl[]  tom_append_array_bidList( BoundIdentDecl[]  l2,  BoundIdentDecl[]  l1) {
    ...
    if(tom_is_fun_sym_Equal(tom_match1_1) ||  false ) {
      ...
      if(tom_is_fun_sym_Identifier(tom_match1_1_left) ||  false ) {
        { Expression  ident=tom_match1_1_left;
        if(tom_is_fun_sym_Card(tom_match1_1_right) ||  false ) {
          { Expression  tom_match1_1_right_child=tom_get_slot_Card_child(tom_match1_1_right);
          { Expression  S=tom_match1_1_right_child;
    ...
    if(tom_is_fun_sym_Equal(tom_match1_1) ||  false ) {
      { Expression  tom_match1_1_left=tom_get_slot_Equal_left(tom_match1_1);
      { Expression  tom_match1_1_right=tom_get_slot_Equal_right(tom_match1_1);
      if(tom_is_fun_sym_Card(tom_match1_1_left) ||  false ) {
        { Expression  tom_match1_1_left_child=tom_get_slot_Card_child(tom_match1_1_left);
        { Expression  S=tom_match1_1_left_child;
        if(tom_is_fun_sym_Identifier(tom_match1_1_right) ||  false ) {
          { Expression  ident=tom_match1_1_right;
    ...
    if(tom_is_fun_sym_Equal(tom_match1_1) ||  false ) {
      ...
      if(tom_is_fun_sym_Identifier(tom_match1_1_left) ||  false ) {
        { Expression  ident=tom_match1_1_left;
        if(tom_is_fun_sym_Bool(tom_match1_1_right) ||  false ) {
          { Predicate  tom_match1_1_right_predicate=tom_get_slot_Bool_predicate(tom_match1_1_right);
          { Predicate  P=tom_match1_1_right_predicate;
    ...
    if(tom_is_fun_sym_Equal(tom_match1_1) ||  false ) {
      { Expression  tom_match1_1_left=tom_get_slot_Equal_left(tom_match1_1);
      { Expression  tom_match1_1_right=tom_get_slot_Equal_right(tom_match1_1);
      if(tom_is_fun_sym_Bool(tom_match1_1_left) ||  false ) {
        { Predicate  tom_match1_1_left_predicate=tom_get_slot_Bool_predicate(tom_match1_1_left);
        { Predicate  P=tom_match1_1_left_predicate;
        if(tom_is_fun_sym_Identifier(tom_match1_1_right) ||  false ) {
          { Expression  ident=tom_match1_1_right;
    ...
    if(tom_is_fun_sym_Card(tom_match2_1) ||  false ) {
