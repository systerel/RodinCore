...
static private  BoundIdentDecl[]  tom_append_array_bidList( BoundIdentDecl[]  l2,  BoundIdentDecl[]  l1) {
	...
	protected Expression translate(Expression expr, FormulaFactory ff) {
		SourceLocation loc = expr.getSourceLocation();
	        { Expression  tom_match1_1=(( Expression )expr);
    if(tom_is_fun_sym_AssociativeExpression(tom_match1_1) ||  false ) {
      { Expression[]  tom_match1_1_children=tom_get_slot_AssociativeExpression_children(tom_match1_1);
    ...
    if(tom_is_fun_sym_AtomicExpression(tom_match1_1) ||  false ) {
 
	    		return expr; 
	    	    }
    if(tom_is_fun_sym_BoundIdentifier(tom_match1_1) ||  false ) {
 
	    		return expr; 
	    	    }
    if(tom_is_fun_sym_FreeIdentifier(tom_match1_1) ||  false ) {
 
	    		return expr; 
	    	    }
    if(tom_is_fun_sym_IntegerLiteral(tom_match1_1) ||  false ) {
 
	    		return expr; 
	    	    }
    if(tom_is_fun_sym_BinaryExpression(tom_match1_1) ||  false ) {
      { Expression  tom_match1_1_left=tom_get_slot_BinaryExpression_left(tom_match1_1);
      { Expression  tom_match1_1_right=tom_get_slot_BinaryExpression_right(tom_match1_1);
    ...
    if(tom_is_fun_sym_Bool(tom_match1_1) ||  false ) {
    ...
    if(tom_is_fun_sym_Cset(tom_match1_1) ||  false ) {
      { BoundIdentDecl[]  tom_match1_1_identifiers=tom_get_slot_Cset_identifiers(tom_match1_1);
      { Predicate  tom_match1_1_predicate=tom_get_slot_Cset_predicate(tom_match1_1);
      { Expression  tom_match1_1_expression=tom_get_slot_Cset_expression(tom_match1_1);
      { BoundIdentDecl[]  is=tom_match1_1_identifiers;
      { Predicate  P=tom_match1_1_predicate;
    ...
    if(tom_is_fun_sym_Qinter(tom_match1_1) ||  false ) {
      { BoundIdentDecl[]  tom_match1_1_identifiers=tom_get_slot_Qinter_identifiers(tom_match1_1);
      { Predicate  tom_match1_1_predicate=tom_get_slot_Qinter_predicate(tom_match1_1);
      { Expression  tom_match1_1_expression=tom_get_slot_Qinter_expression(tom_match1_1);
      { BoundIdentDecl[]  is=tom_match1_1_identifiers;
      { Predicate  P=tom_match1_1_predicate;
      { Expression  E=tom_match1_1_expression;
    ...
    if(tom_is_fun_sym_Qunion(tom_match1_1) ||  false ) {
      { BoundIdentDecl[]  tom_match1_1_identifiers=tom_get_slot_Qunion_identifiers(tom_match1_1);
      { Predicate  tom_match1_1_predicate=tom_get_slot_Qunion_predicate(tom_match1_1);
      { Expression  tom_match1_1_expression=tom_get_slot_Qunion_expression(tom_match1_1);
      { BoundIdentDecl[]  is=tom_match1_1_identifiers;
      { Predicate  P=tom_match1_1_predicate;
      { Expression  E=tom_match1_1_expression;
    ...
    if(tom_is_fun_sym_SetExtension(tom_match1_1) ||  false ) {
    ...
    if(tom_is_fun_sym_UnaryExpression(tom_match1_1) ||  false ) {
	...
	protected Predicate translate(Predicate pred, FormulaFactory ff) {
		SourceLocation loc = pred.getSourceLocation();
	        { Predicate  tom_match2_1=(( Predicate )pred);
    if(tom_is_fun_sym_Land(tom_match2_1) ||  false ) {
      { Predicate[]  tom_match2_1_children=tom_get_slot_Land_children(tom_match2_1);
    ...
    if(tom_is_fun_sym_Lor(tom_match2_1) ||  false ) {
      { Predicate[]  tom_match2_1_children=tom_get_slot_Lor_children(tom_match2_1);
      { Predicate[]  children=tom_match2_1_children;
    ...
    if(tom_is_fun_sym_Not(tom_match2_1) ||  false ) {
    ...
    if(tom_is_fun_sym_RelationalPredicate(tom_match2_1) ||  false ) {
      { Expression  tom_match2_1_left=tom_get_slot_RelationalPredicate_left(tom_match2_1);
      { Expression  tom_match2_1_right=tom_get_slot_RelationalPredicate_right(tom_match2_1);
    ...
    if(tom_is_fun_sym_ForAll(tom_match2_1) ||  false ) {
      { BoundIdentDecl[]  tom_match2_1_identifiers=tom_get_slot_ForAll_identifiers(tom_match2_1);
      { Predicate  tom_match2_1_predicate=tom_get_slot_ForAll_predicate(tom_match2_1);
    ...
    if(tom_is_fun_sym_Exists(tom_match2_1) ||  false ) {
      { BoundIdentDecl[]  tom_match2_1_identifiers=tom_get_slot_Exists_identifiers(tom_match2_1);
      { Predicate  tom_match2_1_predicate=tom_get_slot_Exists_predicate(tom_match2_1);
      { BoundIdentDecl[]  is=tom_match2_1_identifiers;
      { Predicate  P=tom_match2_1_predicate;
    ...
    if(tom_is_fun_sym_BTRUE(tom_match2_1) ||  false ) {
 return pred;     }
    if(tom_is_fun_sym_BFALSE(tom_match2_1) ||  false ) {
 return pred;     }
    { Predicate  P=tom_match2_1;
