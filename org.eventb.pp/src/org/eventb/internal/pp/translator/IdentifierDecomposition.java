...
static private  BoundIdentDecl[]  tom_append_array_bidList( BoundIdentDecl[]  l2,  BoundIdentDecl[]  l1) {
    ...
    if(tom_is_fun_sym_Qunion(tom_match1_1)) {
      ...
      { Expression  tom_match1_1_expression=tom_get_slot_Qunion_expression(tom_match1_1);
				...
				for (BoundIdentDecl decl: tom_match1_1_identifiers) {
				...
				return ff.makeQuantifiedExpression(
					expr.getTag(),
					identDecls,
					new IdentifierDecomposition(identTypes, c).translate(tom_match1_1_predicate, ff),
					new IdentifierDecomposition(identTypes, c).translate(tom_match1_1_expression, ff),
					loc,
      ...
      if(tom_is_fun_sym_Qinter(tom_match1_1)) {
        ...
        if(tom_is_fun_sym_Cset(tom_match1_1)) {
          ...
          if(tom_is_fun_sym_BoundIdentifier(tom_match1_1)) {
            {int tom_match1_1_boundIndex=tom_get_slot_BoundIdentifier_boundIndex(tom_match1_1);

				Pair<Type, Integer> p = identTypes.get(tom_match1_1_boundIndex);
	...
	public Predicate translate(Predicate P, FormulaFactory ff) {
		    { Predicate  tom_match2_1=(( Predicate )P);
    if(tom_is_fun_sym_ForAll(tom_match2_1)) {
      ...
      if(tom_is_fun_sym_Exists(tom_match2_1)) {
